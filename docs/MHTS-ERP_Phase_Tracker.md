...
Next concrete step: the user should (1) do a visual open-in-Word pass on all
  ...
  session had no rendering tool to verify formatting itself (this still
  applies to the regenerated CA pack too); (2) whenever ready, everything
  from Increments 1-3 is still on one unmerged branch
